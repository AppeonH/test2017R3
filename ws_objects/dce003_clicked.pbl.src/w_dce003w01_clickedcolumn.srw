...
type cb_retrieve from commandbutton within w_dce003w01_clickedcolumn
end type
type cb_insert from commandbutton within w_dce003w01_clickedcolumn
end type
type cb_delete from commandbutton within w_dce003w01_clickedcolumn
end type
type dw_1 from datawindow within w_dce003w01_clickedcolumn
end type
type cb_clear from commandbutton within w_dce003w01_clickedcolumn
end type
type cb_save from commandbutton within w_dce003w01_clickedcolumn
end type
type cb_close from commandbutton within w_dce003w01_clickedcolumn
end type
type mle_output from multilineedit within w_dce003w01_clickedcolumn
end type
type mle_view from multilineedit within w_dce003w01_clickedcolumn
end type
type lb_items from listbox within w_dce003w01_clickedcolumn
end type
type gb_3 from groupbox within w_dce003w01_clickedcolumn
end type
type gb_4 from groupbox within w_dce003w01_clickedcolumn
end type
type gb_5 from groupbox within w_dce003w01_clickedcolumn
end type
type mle_describe from multilineedit within w_dce003w01_clickedcolumn
end type
type gb_1 from groupbox within w_dce003w01_clickedcolumn
end type
type gb_2 from groupbox within w_dce003w01_clickedcolumn
end type
end forward
...
global w_dce003w01_clickedcolumn w_dce003w01_clickedcolumn
...
lb_items.additem("DCE003W01P001: Click Column Edit Style")
lb_items.additem("DCE003W01P002: Click Column EditMask Style")
lb_items.additem("DCE003W01P003: Click Column RadioButton Style")
lb_items.additem("DCE003W01P004: Click Column CheckBox Style")
lb_items.additem("DCE003W01P005: Click Column DDDW Style")
lb_items.additem("DCE003W01P006: Click Column DDLB Style")
...
Choose Case ls_item
	Case 'DCE003W01P001'
		if ab_execute then
			//Click Column Edit Style
			Wf_output('Test Point: ' + ls_item,true)
			Wf_output('Describe  : ' + ls_descript,False)
			dw_1.Event Clicked(0,0,ll_row,dw_1.object.v_name)
		else
			
		end if
	Case 'DCE003W01P002'
		if ab_execute then
			//Click Column EditMask Style
			Wf_output('Test Point: ' + ls_item,true)
			Wf_output('Describe  : ' + ls_descript,False)
			dw_1.Event Clicked(0,0,ll_row,dw_1.object.n_salary)
		else
			
		end if
	Case 'DCE003W01P003'
		if ab_execute then
			//Click Column RadioButton Style
			Wf_output('Test Point: ' + ls_item,true)
			Wf_output('Describe  : ' + ls_descript,False)
			dw_1.Event Clicked(0,0,ll_row,dw_1.object.c_sex)
		else
			
		end if
	Case 'DCE003W01P004'
		if ab_execute then
			//Click Column CheckBox Style
			Wf_output('Test Point: ' + ls_item,true)
			Wf_output('Describe  : ' + ls_descript,False)
			dw_1.Event Clicked(0,0,ll_row,dw_1.object.c_married)
		else
			
		end if
	Case 'DCE003W01P005'
		if ab_execute then
			//Click Column DDDW Style
			Wf_output('Test Point: ' + ls_item,true)
			Wf_output('Describe  : ' + ls_descript,False)
			dw_1.Event Clicked(0,0,ll_row,dw_1.object.v_deptid)
		else
			
		end if
	Case 'DCE003W01P006'
		if ab_execute then
			//Click Column DDLB Style
			Wf_output('Test Point: ' + ls_item,true)
			Wf_output('Describe  : ' + ls_descript,False)
			dw_1.Event Clicked(0,0,ll_row,dw_1.object.v_city)
		else
...
on w_dce003w01_clickedcolumn.create
...
on w_dce003w01_clickedcolumn.destroy
...
event open;declare my_proc procedure for department_init using sqlca;
execute my_proc;
commit using sqlca;

declare my_proc1 procedure for dec_emp_init using sqlca;
execute my_proc1;
commit using sqlca;
...
integer taborder = 20
string title = "none"
string dataobject = "d_dce003w01_column"
